...
public class ControlActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference newRef = database.getReference("ESP/ROOM_0");
                ...
                newRef.child("LED").get().addOnCompleteListener(new OnCompleteListener<DataSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<DataSnapshot> task) {
                        if (Boolean.parseBoolean(task.getResult().getValue().toString())){
                            Toast.makeText(ControlActivity.this, "Tắt Đèn", Toast.LENGTH_SHORT).show();
                        }else {
                            Toast.makeText(ControlActivity.this, "Bật Đèn", Toast.LENGTH_SHORT).show();
                        }
        ...
        btnFan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                newRef.child("FAN").get().addOnCompleteListener(new OnCompleteListener<DataSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<DataSnapshot> task) {
                        if (Boolean.parseBoolean(task.getResult().getValue().toString())){
                            Toast.makeText(ControlActivity.this, "Tắt Quạt", Toast.LENGTH_SHORT).show();
                        }else {
                            Toast.makeText(ControlActivity.this, "Bật Quạt", Toast.LENGTH_SHORT).show();
                        }
        ...
        btnPower.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                newRef.child("PUMP").get().addOnCompleteListener(new OnCompleteListener<DataSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<DataSnapshot> task) {
                        if (Boolean.parseBoolean(task.getResult().getValue().toString())){
                            Toast.makeText(ControlActivity.this, "Tắt Vòi Phun", Toast.LENGTH_SHORT).show();
                        }else {
                            Toast.makeText(ControlActivity.this, "Bật Vòi Phun", Toast.LENGTH_SHORT).show();
                        }
